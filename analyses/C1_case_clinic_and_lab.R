...
# )
# saveRDS(df_raw, "data/case/df_raw_SINAN_CHIKV_2013_2025.rds")
# 
# # there are dozens of unnecessary columns. Let us make it slim!
# df_raw_slim <- df_raw %>%
#   select(
#     DT_NOTIFIC,   # notification date
#     DT_SIN_PRI,   # symptom onset date
#     ID_MUNICIP,   # municipality code
#     SG_UF_NOT,    # estado code
#     NU_IDADE_N,   # age (unit-prefix encoded)
#     CS_SEXO,      # sex
#     CLASSI_FIN,   # classification (13 = chikungunya confirmed)
#     CRITERIO      # confirmation type (1 = lab, 2 = clinical)
#   )
# saveRDS(df_raw_slim, "data/case/df_raw_SINAN_CHIKV_2013_2025_slim.rds")
